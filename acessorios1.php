...
<body>
  <div class="container" id="nav">
    <nav>
      ...
      <nav class="sc-hAZoDl cqDFSz">
        <div><a href="inicio.php"><img src="img/icons a ser usadas na navbar/explorar.png" alt="Shop">Home</a></div>
  </div>
  </nav>
  </nav>
  </div>
  ...
  $sql = "SELECT * FROM produto WHERE categoria = 'acessorios1'";
  ...
  if (empty($produto_buscado)) {
    ...
    $sql = "SELECT * FROM produto where primeiro_nome like '%$produto_buscado%' AND categoria = 'acessorios1' order by rand()";
  ...
  ?>
  <section class="sc-cxabCf cEZwIm4">
