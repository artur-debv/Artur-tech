...
<body>
  ...
  $sql = "SELECT * FROM produto WHERE categoria = 'nootbok'";
  ...
  if (empty($produto_buscado)) {
    ...
    $sql = "SELECT * FROM produto where primeiro_nome like '%$produto_buscado%' AND categoria = 'nootbok' order by rand()";
  ...
  ?>
  <section class="sc-cxabCf cEZwIm1">
    <div class="sc-llJcti fSiFFA">
      ...
      <div class="sc-gicCDI DupHf">
        <h4>Atendimento ao cliente</h4><a href="/contact">Ajuda &amp; Contanto</a><a href="/explorar">Loja
          online</a><a href="/">Home</a>
      </div>
    </div>
